        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li><a href="#" title="Seni">Produk Unggulan<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                    <li><a href="#" title="{{ $product->title }}">{{ $product->title  }}</a></li>
                </ul><!-- /.breadcrumbs -->
            </div>
        </div>
    </div>
                    ...
                    <aside class="widget widget_nav_menu" aria-labelledby="sidebar">
                        <div class="menu-services-container" >
                            <ul class="menu menu-tab">
                                ...
                                <li><a href="#pelapak">Lokasi produk</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="wrap-main-post about-v3">
                        ...
                        <div class="box-content" id="pelapak">
                            <div class="box-horizontal">
                                ...
                                <ul>
                                    <li>
                                        <a class="btn btn-social btn-phone" href="Tel:{{ $product->owner_contact }}">
                                            <i class="fa fa-phone"></i> Telepon
                                        </a>
                                    </li>
                                    <li>
                                        <a class="btn btn-social btn-wa" target="__blank" href="https://wa.me/{{ $product->owner_wacontact }}">
                            ...
                            <div class="map-container">
                                <iframe
                                    src="https://maps.google.com/maps?q={{ $product->lat }},{{ $product->long }}&hl=es&z=14&amp;output=embed"
                                    style="border:0;"
                                    allowfullscreen=""
                                    loading="lazy">
                                </iframe>
                        ...
                        @foreach ($products as $item)
                            <li class="item">
                                ...
                                <div class="title-post">
                                    <a href="{{ route('potencies.products.show', $item->slug) }}" title="">
