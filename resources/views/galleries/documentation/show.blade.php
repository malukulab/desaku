        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-title-heading">
                    <h1 class="h1-title">{{ $documentation->title }}</h1>
                ...
                <ul class="breadcrumbs">
                    ...
                    <li><a href="#" title="">Dokumentasi<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                    <li><a href="#" title="">{{ $documentation->title }}</a></li>
                </ul><!-- /.breadcrumbs -->
                ...
                <div class="post-wrap">
                    <article class="main-post">
                        <div class="entry-post-title">
                            <ul class="entry-meta">
                                <li class="date">
                                    {{ $documentation->created_at->locale('id-ID')->isoFormat('LLL') }}
                                </li>
                                <li class="author">
                            ...
                            <div class="flexslider s2">
                                <div class="flat-slides">
                                    <ul class="slides">
                                        ...
                                        @if ($documentation->attachments->count() < 1 && count($embedded) < 1)
                                        <li>
            ...
            <div class="col-md-4">
                <div class="sidebar right">
                    <aside id="recent-post" class=" widget widget-recent">
                        <h3 class="widget-title">Dokumentasi Lainnya</h3>
                            <ul>
                                @foreach ($documentations as $item)
                                <li>
                                    <a title="{{ $item->title }}" href="{{ route('gelleries.documentation.show',  $item->slug) }}">{{  $item->title }} </a><span>{{ $item->created_at->locale('id_ID')->isoFormat('LL')}}</span>
                                </li>
                                @endforeach
                            </ul>
                    </aside>
