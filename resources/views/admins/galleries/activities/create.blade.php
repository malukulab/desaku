...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4>Tambahkan Informasi Kegiatan</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Kegiatan Negeri Hila</h4>
                <p class="card-title-desc">
                    Tambahkan dan terbitkan kegiatan negeri Hila baru Anda
                </p>
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group mb-4">
                                ...
                                <div>
                                    <input value="{{ old('title') }}" class="form-control" placeholder="Masukan nama kegiatan.." type="text" name="title" id="input-title">
                                    @error('title')
