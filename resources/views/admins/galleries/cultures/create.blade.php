...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4>Tambahkan Informasi Budaya</h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">
                    Tambahkan dan terbitkan informasi budaya negeri Hila baru Anda
                </p>
                <form method="POST" action="{{ route('admin.cultures.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group mb-4">
                                ...
                                <div>
                                    <input value="{{ old('title') }}" class="form-control" placeholder="Masukan nama budaya.." type="text" name="title" id="input-title">
                                    @error('title')
